document.addEventListener('DOMContentLoaded', () => {
    ...
    new Typed('#typed-text', {
        strings: ['Software Developer', 'Full-Stack Engineer', 'React Developer', 'Problem Solver'],
        typeSpeed: 50,
        backSpeed: 30,
        backDelay: 1500,
        loop: true,
    ...
    const projectData = [
        ...
        },
        {
            ...
            title: "Samvaad",
            image: "Samvaad.png",
            description: "This is a full-stack, real-time chat application built to demonstrate advanced backend and frontend development skills. The frontend is built with pure HTML5, CSS3, and modern JavaScript, while the backend is fully powered by Supabase.",
            tags: ["HTML", "CSS", "Javascript"," Supabase"],
            liveUrl: "https://s7d4007.github.io/Samvaad/",
            repoUrl: "https://github.com/s7d4007/Samvaad",
            details: `
                        <ul style="color: white; list-style-type: disc; padding-left: 20px;">
                            <li>Secure Authentication : Full user signup, login, and logout flow using Supabase Auth.</li>
                            <li>Real-Time Messaging : Messages appear instantly on both users' screens without a page refresh using Supabase Realtime Subscriptions.</li>
                            <li>1-on-1 Chat Creation : Users can find other users by their email address to start a new, private conversation.</li>
                            <li>Dynamic Chat List : The contact list is dynamically loaded from the database, showing only the current user's active chats.</li>
                        </ul>
                    `
        },
    ];
